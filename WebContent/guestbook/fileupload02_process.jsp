...
// 폼 페이지에서 전송되어 서버에 업로드된 여러 개의 파일을 가져오도록 MultipartRequest 객체 타입의 getFileName() 메소드를 통해 Enumeration 객체 타입에 저장
...
<table border="1">
	...
	<tr>
		<td><%=name1 %></td>
		<td><%=subject1 %></td>
		<td><img src="/images/<%=filename1 %>"></td>
	</tr>
	<tr>
		<td><%=name2 %></td>
		<td><%=subject2 %></td>
		<td><img src="/images/<%=filename2 %>"></td>
	</tr>
	<tr>
		<td><%=name3 %></td>
		<td><%=subject3 %></td>
		<td><img src="/images/<%=filename3 %>"></td>
	</tr>
</table>
